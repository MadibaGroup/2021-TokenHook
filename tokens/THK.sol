/**
 * @title Ethereum Secure Token (EST).
...
contract ERC20 is IERC20 {
    ...
    string public constant name = "Ethereum Secure Token";      /// Token name
    ...
    */
    ...
    function allowance(address tokenHolder, address spender) external view notPaused returns (uint256 tokens) {
        return allowances[tokenHolder][spender];    /// Allowance of `spender` (approved by `tokenHolder`).
    }
    ...
    /**
     * @dev Returns remained amount of tokens to transfer by spender's account.
     */
    function allowed(address tokenHolder, address spender) external view notPaused returns (uint256 tokens) {
